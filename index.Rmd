...
Utilizaremos el indice de silhouette para determinar la cantidad optima de _k_. El mismo es una medida que nos dice que tan similar es un individuo a su cluster comparado con los otros clusters. 
...
Por lo tanto, utilizaremos $k=2$. Esto significa que estamos buscando dos grupos de personas con caracteristicas distintas entre si.
